(function () {
    ...
    app.controller('UsuariosController', ['$scope', '$http', 'ngDialog', '$controller', function ($scope, $http, ngDialog, $controller) {
        ...
        // Cargar el nombre de los estados
        ...
        // Cargar los estados de los usuarios
        ...
        // Obtener todos los roles para asignar un usuario
        ...
        // Insertar un registro a la lista de usuarios
        ...
        // Agregar un registro en la lista de usuaios
        ...
        return {
            ...
            link: function (scope, element, attr, ctrl) {
                ...
                function customValidator(ngModelValue) {
                    ...
                    // if it does contain uppercase, set our custom `uppercaseValidator` to valid/true otherwise set it to non-valid/false
