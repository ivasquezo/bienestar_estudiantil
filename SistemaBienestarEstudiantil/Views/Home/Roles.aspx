...
<asp:Content ID="rolContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div ng-controller="RolsController as Main">
        ...
        <button ng-click="addNewRolDialog()" style="margin-bottom:5px;" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary"
            role="button">
                            ...
                            <td>
                                <div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span class="help-block">Nombre del rol</span>
